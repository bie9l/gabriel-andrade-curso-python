    ...
    while True:
        try:
            ...
            if escolha_usuario == aleatorio:
                print("Empate")
            elif escolha_usuario == 0 and aleatorio == 2:
                print('Você ganhou !')
            elif escolha_usuario == 1 and aleatorio == 0:
                print('Você ganhou !')
            elif escolha_usuario == 2 and aleatorio == 1:
                print('Você ganhou !')
            elif escolha_usuario == 0 and aleatorio == 1:
                print('Você perdeu !')
            elif escolha_usuario == 1 and aleatorio == 2:
                print('Você perdeu !')
            elif escolha_usuario == 2 and aleatorio == 0:
                print('Você perdeu !')
            else:
